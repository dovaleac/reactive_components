...
public class DepleteLeftJoinStrategyInstance<LT, RT, KT, KT2> implements JoinStrategyInstance<LT,
    RT> {
  ...
  public DepleteLeftJoinStrategyInstance(
      Scenario<LT, RT, KT, KT2> scenario, Map<KT, LT> initialMap,
