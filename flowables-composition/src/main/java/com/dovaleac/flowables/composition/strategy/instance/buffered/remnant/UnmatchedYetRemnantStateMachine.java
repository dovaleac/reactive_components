...
public class UnmatchedYetRemnantStateMachine {
  ...
  StateMachineConfig<UnmatchedYetRemnantState, UnmatchedYetRemnantTrigger> getConfig() {
    ...
    Stream.of(UnmatchedYetRemnantState.values())
        .forEach(
            state ->
                Stream.of(UnmatchedYetRemnantTrigger.values())
                    .forEach(
                        trigger ->
                            config
                                .configure(state)
                                .onEntryFrom(
                                    trigger,
                                    () -> unmatchedYetRemnant.logTriggerEvent(trigger, state))));
    ...
    config
        ...
        .ignore(UnmatchedYetRemnantTrigger.PROCESS_READ);
    ...
    config
        ...
        .permit(UnmatchedYetRemnantTrigger.SYNC_REQUESTED, SYNCHRONIZATION_CONFLICT)
        .ignore(UnmatchedYetRemnantTrigger.IT_WOULD_BE_BETTER_TO_WRITE)
        .ignore(UnmatchedYetRemnantTrigger.PROCESS_READ);
    ...
    config
        .configure(SYNCHRONIZATION_CONFLICT)
        .onEntry(unmatchedYetRemnant::claimToBeTheSynchronizer)
        .permit(UnmatchedYetRemnantTrigger.CONFLICT_SOLVED_AS_SYNCHRONIZEE, SYNCHRONIZEE)
        .permit(UnmatchedYetRemnantTrigger.SYNC_ACCEPTED, SYNCHRONIZER)
        .ignore(UnmatchedYetRemnantTrigger.IT_WOULD_BE_BETTER_TO_WRITE);
    ...
    config
        ...
        .ignore(UnmatchedYetRemnantTrigger.SYNC_REQUESTED)
        .ignore(UnmatchedYetRemnantTrigger.PROCESS_READ);
