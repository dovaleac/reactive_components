 ...
 *
 *    Copyright 2019 Pablo González Doval
 *
...
public class TwoKeysScenario<LT, RT, KT, K2T> implements Scenario<LT, RT, KT, K2T> {
  ...
  protected final Class<K2T> k2TClass;
  protected final Function<LT, K2T> lk2Function;
  protected final Function<RT, K2T> rk2Function;
  ...
  @Override
  public Class<K2T> getK2TClass() {
    return k2TClass;
  }

  @Override
  public Function<LT, K2T> getLk2Function() {
    return lk2Function;
  }

  @Override
  public Function<RT, K2T> getRk2Function() {
    return rk2Function;
  }
